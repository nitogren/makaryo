...
echo $timestamp;
echo @color('red'," -DI BUAT KHUSUS UNTUK PANJI TERSAYANG-");
echo @color('yellow',"\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
echo "\n";
...
echo "\n";
    ...
    echo @color('nevy',"                    TEAM PANJI JANCOK'AN \n");
    echo @color('nevy',"                       BERAKSI.  \n");
    echo @color('nevy',"                        NGERAMPOK ");
    echo @color('red',"\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    echo "\n";
...
$data = '{"CustomerID":"'.$id.'","AddressType":0,"StoreCode":"T77K"}';
...
echo "\n";
if ($fee == "FAILED"){
	echo @color('red'," Kupon $kpn (Diskon di klik Indomaret) Gagal Di Klaim Ke No $no Karena RAIMU KAKEAN DUSO  \n");
